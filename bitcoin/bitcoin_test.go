...
var _ = Describe("Bitcoin", func() {
	...
	It("can initiate a bitcoin atomic swap", func() {
		...
		err := BTCAtom.Initiate(hashLock[:], []byte("mgTCJazbqe8JUCNQTbcVLJDv5yseRfAMVe"), []byte("mv8p79yFBUfrbWCSMPc4fNTThZS1zdPpR6"), 1000000, 1518570598)
		Ω(err).Should(BeNil())
