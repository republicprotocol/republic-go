...
// 	DarkOcean         *darknode.Ocean
// 	DarkPool          *darknode.Pool
...
// // start any of them.
// func NewDarkNode(config Config, darkNodeRegistrar dnr.DarkNodeRegistry) (*DarkNode, error) {
// 	var err error
// 	node := &DarkNode{
// 		Config:             config,
...
// 	node.DarkOcean, err = darknode.NewOcean(node.Logger, darkNodeRegistrar)
// 	if err != nil {
// 		return nil, err
// 	}
// 	node.DarkPool = darknode.NewPool()
...
// // separately.
// func (node *DarkNode) ConnectToDarkPool(darkPool *darknode.Pool) {
// 	// Terminate if the dark pool is no longer relevant
// 	if darkPool == nil {
// 		return
// 	}

// 	darkPool.ForAll(func(n *darknode.Node) {
...
// 		darkPool.For(func(n *darknode.Node) {
