...
type XingNodeClient interface {
	...
	GetResults(ctx context.Context, in *MultiAddress, opts ...grpc.CallOption) (*Results, error)
}
...
func (c *xingNodeClient) GetResults(ctx context.Context, in *MultiAddress, opts ...grpc.CallOption) (*Results, error) {
	out := new(Results)
...
type XingNodeServer interface {
	...
	// Get all relevant results that have been computed in the current epoch.
	GetResults(context.Context, *MultiAddress) (*Results, error)
}
...
func _XingNode_GetResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(XingNodeServer).GetResults(ctx, req.(*MultiAddress))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
