...
var contractAddress = common.HexToAddress("0xbd59e72598737a08a68fe192df04c773adbbfa53")
...
var _ = Describe("Ethereum", func() {
	...
	It("can't expire an expired order", func() {
		hash, err := hex.DecodeString("1d2f007c416ddec089ba60cd052e64e25f8fe7dde85625e2d3354b8faf3ef4ae")
		Ω(err).Should(BeNil())
