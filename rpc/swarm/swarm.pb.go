...
func init() {
	proto.RegisterType((*PingRequest)(nil), "swarm.PingRequest")
	proto.RegisterType((*PingResponse)(nil), "swarm.PingResponse")
	proto.RegisterType((*QueryRequest)(nil), "swarm.QueryRequest")
	proto.RegisterType((*QueryResponse)(nil), "swarm.QueryResponse")
}
...
func (c *swarmClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := grpc.Invoke(ctx, "/swarm.Swarm/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *swarmClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (Swarm_QueryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Swarm_serviceDesc.Streams[0], c.cc, "/swarm.Swarm/Query", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
