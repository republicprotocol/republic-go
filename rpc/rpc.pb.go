...
type SyncBlock_Canceled struct {
	Canceled *Order `protobuf:"bytes,4,opt,name=canceled,oneof"`
}
type SyncBlock_Unconfirmed struct {
	Unconfirmed *Order `protobuf:"bytes,5,opt,name=unconfirmed,oneof"`
}
type SyncBlock_Confirmed struct {
	Confirmed *Order `protobuf:"bytes,6,opt,name=confirmed,oneof"`
}
type SyncBlock_Settled struct {
	Settled *Order `protobuf:"bytes,7,opt,name=settled,oneof"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
