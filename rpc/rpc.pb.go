...
type NodeClient interface {
	...
	Ping(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*MultiAddress, error)
...
func (c *nodeClient) Ping(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*MultiAddress, error) {
...
type NodeServer interface {
	// Ping the Node to test the connection.
	Ping(context.Context, *Nothing) (*MultiAddress, error)
	// Get peers connected to the Node.
...
var fileDescriptor0 = []byte{
	...
	0x29, 0x71, 0x72, 0xb1, 0xfb, 0xe5, 0x97, 0x64, 0x64, 0xe6, 0xa5, 0x1b, 0x75, 0x30, 0x72, 0xb1,
	0xf8, 0xe5, 0xa7, 0xa4, 0x0a, 0xa9, 0x73, 0xb1, 0x04, 0x64, 0xe6, 0xa5, 0x0b, 0xf1, 0xe8, 0x81,
	0x1c, 0x07, 0x95, 0x96, 0x12, 0x04, 0xf3, 0x50, 0x2c, 0xd7, 0xe2, 0x62, 0x0d, 0x48, 0x4d, 0x2d,
	0x2a, 0x46, 0x53, 0x29, 0x8c, 0xa1, 0x32, 0xb5, 0x58, 0x48, 0x9b, 0x8b, 0xdb, 0x39, 0x27, 0xbf,
	0x38, 0xb5, 0x08, 0xa2, 0x83, 0x1d, 0xac, 0xc6, 0xd3, 0x05, 0xab, 0xe2, 0x24, 0x36, 0x70, 0x88,
	0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x26, 0x39, 0xa6, 0xfd, 0x1e, 0x01, 0x00, 0x00,
}
