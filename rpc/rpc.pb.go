...
type NodeClient interface {
	...
	FindCloserPeers(ctx context.Context, in *Query, opts ...grpc.CallOption) (*MultiAddresses, error)
...
func (c *nodeClient) FindCloserPeers(ctx context.Context, in *Query, opts ...grpc.CallOption) (*MultiAddresses, error) {
	out := new(MultiAddresses)
...
type NodeServer interface {
	...
	// Find the MultiAddresses of peers closer to some target Node.
	FindCloserPeers(context.Context, *Query) (*MultiAddresses, error)
	// Send an OrderFragment to some target Node.
...
func _Node_FindCloserPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).FindCloserPeers(ctx, req.(*Query))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
